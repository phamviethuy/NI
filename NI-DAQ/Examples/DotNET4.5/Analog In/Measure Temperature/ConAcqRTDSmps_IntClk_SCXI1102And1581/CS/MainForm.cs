...
namespace NationalInstruments.Examples.ConAcqRTDSmps_IntClk_SCXI1102And1581
{
    /// <summary>
    ...
    {
        private AnalogMultiChannelReader myReader;
        ...
        private void InitializeComponent()
        {
            ...
            this.rtdParametersGroupBox.Size = new System.Drawing.Size(224, 88);
            ...
            this.r0Numeric.Location = new System.Drawing.Point(120, 56);
            ...
            this.rtdTypeComboBox.Items.AddRange(new object[] {
                                                                 ...
                                                                 "Pt3920",
                                                                 "Pt3928"});
            this.rtdTypeComboBox.Location = new System.Drawing.Point(120, 24);
            ...
            this.resistanceParametersGroupBox.Location = new System.Drawing.Point(240, 8);
            ...
            this.acquisitionResultsGroupBox.Location = new System.Drawing.Point(240, 144);
            ...
            this.Text = "Continuous Acquire RTD Samples - Internal Clock - SCXI 1102 And 1581";
        ...
        private void startButton_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                myTask = new Task();
                AIRtdType rtdType;
                AIResistanceConfiguration resistanceConfig;
                ...
                {
                    case 0:
                        resistanceConfig = AIResistanceConfiguration.TwoWire;
                        break;
                    case 1:
                        resistanceConfig = AIResistanceConfiguration.ThreeWire;
                        break;
                    case 2:
                    default:
                        resistanceConfig = AIResistanceConfiguration.FourWire;
                        break;
                }
                ...
                myTask.AIChannels.CreateRtdChannel(physicalChannelComboBox.Text, "",
                    ...
                    AITemperatureUnits.DegreesC, rtdType, resistanceConfig, excitationSource,
                ...
                myReader.BeginReadWaveform(Convert.ToInt32(rateNumeric.Value), myAsyncCallback, myTask);
            }
        ...
        private void AnalogInCallback(IAsyncResult ar)
        {
            try
            {
                if (runningTask != null && runningTask == ar.AsyncState)
                {
                    ...
                    myReader.BeginMemoryOptimizedReadWaveform(Convert.ToInt32(rateNumeric.Value), myAsyncCallback, myTask, data);
                }
            }
