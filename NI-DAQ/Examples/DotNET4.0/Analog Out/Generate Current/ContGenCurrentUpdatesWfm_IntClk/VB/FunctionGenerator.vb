...
Public Class FunctionGenerator
    ...
    Private Sub Init( _
        ...
        If (type = WaveformType.SineWave) Then
            _data = GenerateSineWave(_resultingFrequency, amplitude, _resultingSampleClockRate, samplesPerBuffer, offset)
        End If
    ...
    Public Shared Function GenerateSineWave( _
        ...
        ByVal samplesPerBuffer As Double, _
        ByVal offset As Double) As Double()
        ...
        For i As Integer = 0 To intSamplesPerBuffer - 1
            rVal(i) = amplitude * Math.Sin((2.0 * Math.PI) * frequency * (i * deltaT)) + offset
        Next
