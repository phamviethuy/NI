...
namespace NationalInstruments.Examples.ComplexWindowing
{
    /// <summary>
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        internal ComplexGraph windowedDataWaveformGraph;
        internal WaveformPlot windowedDataPlot;
        internal XAxis windowedDataXAxis;
        internal YAxis windowedDataYAxis;
        ...
        {   
            ...
            double[] halfValues = new double[250];
            

            // Generate and display the original signals
            ...
            double [] signalI = signal1.Generate(500, 500);
            double [] signalQ = signal2.Generate(500, 500);
            AnalogWaveform<double>[] waveforms = new AnalogWaveform<double>[2];
            waveforms[0] = AnalogWaveform<double>.FromArray1D(signalI);
            waveforms[1] = AnalogWaveform<double>.FromArray1D(signalQ);
            addTimeDomainWaveformGraph.PlotWaveforms(waveforms);
            legend.Items.Clear();
            legend.Items.Add(new LegendItem(addTimeDomainWaveformGraph.Plots[0], "Signal I"));
            legend.Items.Add(new LegendItem(addTimeDomainWaveformGraph.Plots[1], "Signal Q"));

            // Generate and display the window preview
            ...
            ComplexDouble[] complexSignal = new ComplexDouble[500];
            for (int i = 0; i < complexSignal.Length; i++)
                complexSignal[i] = new ComplexDouble(signalI[i], signalQ[i]);  
            scaledWindow.Apply(complexSignal);
            windowedDataWaveformGraph.PlotComplex(complexSignal);
        ...
        private void InitializeComponent()
        {
            ...
            this.windowedDataWaveformGraph = new NationalInstruments.UI.WindowsForms.ComplexGraph();
            ...
            this.freqDomainWaveformGraph.Location = new System.Drawing.Point(361, 266);
            ...
            // 
            this.addTimeDomainWaveformGraph.Caption = "Time Domain";
            ...
            this.dbLabel.Location = new System.Drawing.Point(124, 469);
            ...
            this.linearLabel.Location = new System.Drawing.Point(188, 469);
            ...
            // linearLogSwitch
            // 
            this.linearLogSwitch.Location = new System.Drawing.Point(133, 457);
            ...
            this.inputSignal1GroupBox.Text = "Input Signal (I)";
            // 
            ...
            this.input1AmplitudeNumericEdit.Range = new NationalInstruments.UI.Range(0.1, double.PositiveInfinity);
            this.input1AmplitudeNumericEdit.Size = new System.Drawing.Size(72, 20);
            this.input1AmplitudeNumericEdit.TabIndex = 0;
            this.input1AmplitudeNumericEdit.Value = 50;
            // 
            ...
            this.input1FrequencyNumericEdit.Range = new NationalInstruments.UI.Range(1, double.PositiveInfinity);
            ...
            this.inputSignal2GroupBox.Text = "Input Signal (Q)";
            // 
            ...
            this.input2AmplitudeNumericEdit.Range = new NationalInstruments.UI.Range(1, double.PositiveInfinity);
            ...
            this.input2FrequencyNumericEdit.Range = new NationalInstruments.UI.Range(1, double.PositiveInfinity);
            ...
            this.legend.Location = new System.Drawing.Point(361, 228);
            this.legend.Name = "legend";
            this.legend.Size = new System.Drawing.Size(360, 32);
            this.legend.TabIndex = 50;
            // 
            // MainForm
            // 
