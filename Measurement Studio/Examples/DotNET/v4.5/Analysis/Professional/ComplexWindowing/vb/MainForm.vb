...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents windowedDataWaveformGraph As NationalInstruments.UI.WindowsForms.ComplexGraph
    ...
    Friend WithEvents legend As NationalInstruments.UI.WindowsForms.Legend
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.windowedDataWaveformGraph = New NationalInstruments.UI.WindowsForms.ComplexGraph
        ...
        Me.legend = New NationalInstruments.UI.WindowsForms.Legend
        ...
        Me.freqDomainWaveformGraph.Location = New System.Drawing.Point(368, 266)
        ...
        '
        Me.addTimeDomainWaveformGraph.Caption = "Time Domain"
        ...
        Me.dbLabel.Location = New System.Drawing.Point(132, 471)
        ...
        Me.linearLabel.Location = New System.Drawing.Point(188, 471)
        ...
        'linearLogSwitch
        '
        Me.linearLogSwitch.Location = New System.Drawing.Point(140, 459)
        ...
        Me.inputSignal1GroupBox.Text = "Input Signal (I)"
        '
        ...
        Me.inputSignal2GroupBox.Text = "Input Signal (Q)"
        '
        ...
        'legend
        '
        Me.legend.ItemLayoutMode = NationalInstruments.UI.LegendItemLayoutMode.LeftToRight
        Me.legend.Location = New System.Drawing.Point(368, 228)
        Me.legend.Name = "legend"
        Me.legend.Size = New System.Drawing.Size(360, 32)
        Me.legend.TabIndex = 34
        '
        'MainForm
        '
...
#End Region
    ...
    Private Sub RecalculateAndDrawGraphs()
        ...
        Dim signalI() As Double = signal1.Generate(500, 500)
        Dim signalQ() As Double = signal2.Generate(500, 500)
        Dim waveforms() As AnalogWaveform(Of Double) = New AnalogWaveform(Of Double)(1) {}
        waveforms(0) = AnalogWaveform(Of Double).FromArray1D(signalI)
        waveforms(1) = AnalogWaveform(Of Double).FromArray1D(signalQ)
        ...
        Dim complexSignal As ComplexDouble() = New ComplexDouble(499) {}
        For i As Integer = 0 To complexSignal.Length - 1
        ...
        Dim powerSpectrum As Double() = Transforms.PowerSpectrum(complexSignal)
        ...
        For x = 0 To 249
            ...
            If Not linearLogSwitch.Value Then
                halfValues(x) = 20 * Math.Log10(halfValues(x))
                'User chose dB
            End If
        Next
