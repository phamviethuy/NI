...
namespace NationalInstruments.Examples.AnalogDataFileProcessor
{
	...
	/// constructor of this ConfigureSimulatedAcquisitionForm. 
	/// If ConfigureSimulatedAcquisitionForm.ShowDialog() return DialogResult.OK,
	/// the user successfully configured the BasicFunctionGenerator instance.
	/// </summary>
	public class ConfigureSimulatedAcquisitionForm : System.Windows.Forms.Form
	{
		...
		public ConfigureSimulatedAcquisitionForm(BasicFunctionGenerator simulatedDataGenerator)
		{
			//
		...
		private void InitializeComponent()
		{
            ...
            // 
            // ConfigureSimulatedAcquisitionForm
            // 
            ...
            this.Name = "ConfigureSimulatedAcquisitionForm";
            this.Text = "Configure Simulated Acquisition";
            this.Load += new System.EventHandler(this.ConfigureSimulatedAcquisitionForm_Load);
        ...
        private void ConfigureSimulatedAcquisitionForm_Load(object sender, System.EventArgs e)
        {
            PopulateControls();
        }
