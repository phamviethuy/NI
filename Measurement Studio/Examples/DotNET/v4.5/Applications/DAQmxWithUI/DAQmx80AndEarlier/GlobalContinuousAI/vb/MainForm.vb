...
#Region "Windows Form Designer generated code"
    Private Sub InitializeComponent()
        ...
        Me.globalContinuousAIWaveformGraph.Location = New System.Drawing.Point(8, 96)
        ...
        Me.infoLabel.Text = "Before running this application make sure you have a continuous analog input task" & _
        " in MAX.  The GlobalContinuousAI.nce file in the example directory contains a ta" & _
        "sk that you can import to MAX. Double click on the nce file, MAX will be launche" & _
        "d and then follow the installation directions."
        '
        'MainForm
        '
        ...
        Me.Text = "Global Continuous Analog Input"
