...
*
*       Note: If you prefer, you can import a continuous AI task and a simulated 
*       device into MAX from the GlobalContinuousAI.nce file, which is located in the 
...
namespace NationalInstruments.Examples.GlobalContinuousAI
{
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.globalContinuousAIWaveformGraph.Location = new System.Drawing.Point(8, 96);
            ...
            this.waveformPlot1});
            this.globalContinuousAIWaveformGraph.Size = new System.Drawing.Size(504, 304);
            ...
            this.infoLabel.Text = @"Before running this application make sure you have a continuous analog input task in MAX.  The GlobalContinuousAI.nce file in the example directory contains a task that you can import to MAX. Double click on the nce file, MAX will be launched and then follow the installation directions.";
            // 
            // MainForm
            // 
            ...
            this.Text = "Global Continuous Analog Input";
        ...
        private void startButton_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                reader.BeginReadMultiSample(Convert.ToInt32(continuousTask.Timing.SamplesPerChannel), callBack, continuousTask);
        ...
        public void ReadCallBack(IAsyncResult ar)
        {
            try
            {
                if (runningTask != null && runningTask == ar.AsyncState)
                {
                    ...
                    globalContinuousAIWaveformGraph.PlotYAppendMultiple(data);
