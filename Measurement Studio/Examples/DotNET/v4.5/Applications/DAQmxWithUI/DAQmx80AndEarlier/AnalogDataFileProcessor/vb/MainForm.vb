...
Public Class MainForm
    ...
    Private analogConfigureSimulatedAcqForm As ConfigureSimulatedAcqForm
    Private resources As ResourceManager
    Private activeDataRecord As AnalogDataRecord
    Private activeDataRecordSaved As Boolean = True
...
#Region " Windows Form Designer generated code "
    ...
    Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
        If disposing Then
            ...
            End If
            If Not (analogConfigureSimulatedAcqForm Is Nothing) Then
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me._saveFileDialog.Filter = "Analog Data files (*.adf) |*.adf"
        Me._saveFileDialog.Title = "Save DAQmx Analog Data File"
        '
        'mainMenu
        '
        ...
        Me._openFileDialog.Filter = "Analog Data files (*.adf) |*.adf"
        Me._openFileDialog.Title = "Open DAQmx Analog Data File"
        '
        ...
        Me.Menu = Me.mainMenu
        Me.Name = "MainForm"
        Me.Text = "DAQmx Analog Data File Processor"
...
#End Region
    ...
    Private Sub fileMenuOpenItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles fileMenuOpenItem.Click
        If _openFileDialog.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Dim record As AnalogDataRecord = Nothing
            If ReadRecordFromFile(_openFileDialog.FileName, record) Then
    ...
    Private Sub fileMenuSaveSelectionItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles fileMenuSaveSelectionItem.Click
        ...
        If PromptForSaveFileName(fileName) Then
            ...
            Dim data(numberOfSamples) As Double
            ...
            '
            Dim firstXPosition As Double = System.Math.Min(dataCursor1.XPosition, dataCursor2.XPosition)
            Dim startTime As DateTime = DirectCast(DataConverter.Convert(firstXPosition, GetType(DateTime)), DateTime)

            Dim dataRecord As New AnalogDataRecord(data, startTime, activeDataRecord.SampleIncrement)
    ...
    Private Sub PlotActiveDataRecord()
    ...
    Private Sub WriteRecordToFile(ByVal filePath As String, ByVal dataRecord As AnalogDataRecord)
    ...
    Private Function ReadRecordFromFile(ByVal filePath As String, ByRef dataRecord As AnalogDataRecord) As Boolean
        Dim stream As FileStream = File.OpenRead(filePath)
        Try
            Dim formatter As New BinaryFormatter
            dataRecord = formatter.Deserialize(stream)
    ...
    Private Sub MainForm_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        If Not activeDataRecordSaved Then
