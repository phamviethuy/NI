...
Public Class MainForm
    ...
    Dim data As AnalogWaveform(Of Double) = New AnalogWaveform(Of Double)(1000)
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'samplesNumericEdit
        '
        Me.samplesNumericEdit.CoercionMode = NationalInstruments.UI.NumericCoercionMode.ToInterval
        Me.samplesNumericEdit.FormatMode = NationalInstruments.UI.NumericFormatMode.CreateSimpleDoubleMode(0)
        Me.samplesNumericEdit.Location = New System.Drawing.Point(24, 152)
        ...
        Me.samplesNumericEdit.Range = New NationalInstruments.UI.Range(1, 33554432)
        Me.samplesNumericEdit.Size = New System.Drawing.Size(88, 20)
        Me.samplesNumericEdit.TabIndex = 5
        ...
        Me.rateNumericEdit.Location = New System.Drawing.Point(24, 96)
        ...
        Me.rateNumericEdit.Range = New NationalInstruments.UI.Range(1, 6666666)
        Me.rateNumericEdit.Size = New System.Drawing.Size(88, 20)
        Me.rateNumericEdit.TabIndex = 3
        Me.rateNumericEdit.Value = 10000
        '
        ...
        Me.powerSpectrumYAxis.Range = New NationalInstruments.UI.Range(-2, 8)
        '
        'acquisitionLabel
        '
...
#End Region
    ...
    Private Sub acquisitionStateSwitch_StateChanged(ByVal sender As System.Object, ByVal e As NationalInstruments.UI.ActionEventArgs) Handles acquisitionStateSwitch.StateChanged
        Try
            ...
            If (acquisitionStateSwitch.Value And (runningTask Is Nothing)) Then
                ...
                Dim samplingRate As Double = rateNumericEdit.Value
                ...
                reader.BeginMemoryOptimizedReadWaveform(samplesPerChannel, New AsyncCallback(AddressOf myCallback), myTask, data)
    ...
    Private Sub getUnitConvertedAutoPowerSpectrum(ByVal waveform As AnalogWaveform(Of Double))
        ...
        Dim data As Double() = waveform.GetScaledData()
        scaleWindow.Apply(data, equivalentNoiseBandwidth, coherentGain)
        'Calculate the auto power spectrum of signal waveform.
        autoPowerSpectrum = Measurements.AutoPowerSpectrum(data, waveform.Timing.SampleInterval.TotalSeconds, df)
        ...
        Dim unitConvertedSpectrum As Double() = Measurements.SpectrumUnitConversion(autoPowerSpectrum, NationalInstruments.Analysis.SpectralMeasurements.SpectrumType.Power, scaleMode, unitOfdisplay, df, equivalentNoiseBandwidth, coherentGain, unit)
