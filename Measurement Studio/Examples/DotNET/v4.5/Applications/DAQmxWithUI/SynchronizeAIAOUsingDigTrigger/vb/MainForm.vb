...
Public Class MainForm
    ...
    Private outputChannelComboBox As System.Windows.Forms.ComboBox
    ...
    Private inputMinValueNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    Private inputMaxValueNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    Private numberOfSamplesNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    Private sampleRateNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    Private outputMinValueNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    Private outputMaxValueNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    Private amplitudeNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    Private frequencyNumericEdit As NationalInstruments.UI.WindowsForms.NumericEdit
    ...
    Private Sub startButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles startButton.Click
        ...
        Try
            ...
            Dim outData As Double() = fgen.Generate()
