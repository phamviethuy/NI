<%@ Page Language="VB" MasterPageFile="~/Examples.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="DefaultAspx" Title="Measurement Studio ASP.NET Web Forms Controls" %>

<asp:Content ID="Content1" ContentPlaceHolderID="exampleContentHolder" Runat="server">
    <table width="100%" cellspacing="0" cellpadding="7" border="0">
        ...
        <tr valign="top">
            <td style="width:125px;">
                <asp:HyperLink ID="lnkComplexWaveformPlotting" Runat="server" NavigateUrl="~/ComplexWaveformPlotting/Default.aspx">Complex Waveform Plotting</asp:HyperLink>
                <br />
                <asp:ImageButton ID="ImageButton16" runat="server" ImageUrl="~/ComplexWaveform.png" PostBackUrl="~/ComplexWaveformPlotting/Default.aspx" /></td>
            <td>
