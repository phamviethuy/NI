<%@ Page Language="VB" MasterPageFile="~/Examples.master" CodeFile="Default.aspx.vb" Inherits="DefaultAspx" Title="Measurement Studio ASP.NET Graph Interaction Example" %>
            ...
            <td>
                <fieldset>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="2" border="0">
                        ...
                        <tr valign="top">
                            <td style="font-weight:bold;width:115px;">Click</td>
                            <td>If "Zoom Around Point" is enabled, zooms around the clicked point</td>
                        </tr>
                        
                        <tr valign="top">
                            <td style="font-weight:bold;width:115px;">Click+Drag</td>
                            <td>If "Zoom X" or "Zoom Y" is enabled, draws a selection rectangle and zooms into
                            the selected area.</td>
                        </tr>
                        
                        <tr valign="top">
                            <td style="font-weight:bold;width:115px;">Shift+Click</td>
                            <td>Undo a zoom operation or range edit.</td>
                        </tr>
                        
                        <tr valign="top">
                            <td style="font-weight:bold;width:115px;">Shift+Ctrl+Click</td>
