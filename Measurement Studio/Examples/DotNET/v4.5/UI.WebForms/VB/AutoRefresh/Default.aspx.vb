...
Partial Class DefaultAspx
    ...
    Private Const SessionCurrentValueKey As String = "AutoRefresh-CurrentValue"
    Private Const SessionMinimumValueKey As String = "AutoRefresh-MinimumValue"
    Private Const SessionMaximumValueKey As String = "AutoRefresh-MaximumValue"
    Private Const SessionAverageValueKey As String = "AutoRefresh-AverageValue"
