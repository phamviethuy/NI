<%@ Page Language="VB" MasterPageFile="~/Examples.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="DefaultAspx" Title="Measurement Studio ASP.NET Auto Refresh Example" %>
 ...
 <table width="100%" cellspacing="0" cellpadding="2" border="0">      
    ...
    <ni:AutoRefresh ID="refresh" Runat="server" Interval="00:00:00.750" OnRefresh="OnRefresh">
        <DefaultRefreshItems>
            ...
            <ni:RefreshItem ItemID="currentValueID" />
        </DefaultRefreshItems>
    </ni:AutoRefresh>
</asp:Content>
