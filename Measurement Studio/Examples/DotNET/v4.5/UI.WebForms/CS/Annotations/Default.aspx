...
<asp:Content Runat="server" ContentPlaceHolderID="exampleContentHolder">
 <table cellpadding="5">
    ...
    <td colspan="2">
        ...
        <td>
            <ni:NumericEdit ID="maxShapeWidthNumEdit" Runat="server" AutoPostBack="True" Value="20" FormatMode="SimpleDouble: 0" OnAfterChangeValue="maxShapeWidthNumEdit_AfterChangeValue" />
        </td>
        </tr>
        <tr>
        <td>
        ...
        <td>
        <ni:NumericEdit ID="maxShapeHeightNumEdit" Runat="server" AutoPostBack="True" Value="20" FormatMode="SimpleDouble: 0" OnAfterChangeValue="maxShapeHeightNumEdit_AfterChangeValue" />
        </td>
        </tr>
        <tr>
        <td>
        ...
        <td>
            <ni:NumericEdit ID="minShapeWidthNumEdit" Runat="server" AutoPostBack="True" Value="20" FormatMode="SimpleDouble: 0" OnAfterChangeValue="minShapeWidthNumEdit_AfterChangeValue" />
        </td>
        </tr>
        <tr>
        <td>
        ...
        <td>
        <ni:NumericEdit ID="minShapeHeightNumEdit" Runat="server" AutoPostBack="True" Value="20" FormatMode="SimpleDouble: 0" OnAfterChangeValue="minShapeHeightNumEdit_AfterChangeValue" />
        </td>
        </tr>
        <tr>
        <td>
